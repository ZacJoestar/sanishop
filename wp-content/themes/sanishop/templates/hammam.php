		...
		<div class="col-md-4 black-paragraph-card">
			<div class="bg-paragraph-card-wrapper">
                ...
                <ul class="list list-white">
                    <li>Le hammam vous enveloppe dans une véritable bulle de détente</li>
                    <li>Le hammam élimine les toxines, il ouvre les pores et nettoie la peau en profondeur</li>
                    <li>Une séance de hammam soulage les douleurs musculaires et les tensions</li>
                    <li>Le hammam libère les sinus et aide à mieux respirer</li>
                    <li>Grâce à l’alternance du bain turc, le hammam relance la circulation sanguine</li>
                </ul>
			</div>
		</div>
		<div class="col-md-4 bg-paragraph-card" style="background: url('<?php echo esc_url( get_template_directory_uri() ); ?>/src/images/para-bg-2.jpg') no-repeat center center; background-size:cover">
