                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="logo-footer">
                                ...
                                <div class="footer-icons">
                                    <i class="fab fa-facebook-f" style="font-size:2em;color:#fff"></i>
                                    <i class="fab fa-twitter" style="font-size:2em;color:#fff"></i>
                                    <i class="fab fa-google-plus-g" style="font-size:2em;color:#fff"></i>
                                    <i class="fas fa-phone" style="font-size:2em;color:#fff"></i>
                                    <i class="fas fa-envelope" style="font-size:2em;color:#fff"></i>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 wrapper-footer">
                            ...
                            <ul class="list-footer">
                                <li class="list-footer list-footer--item">item</li>
                                <li class="list-footer list-footer--item">item</li>
                                <li class="list-footer list-footer--item">item</li>
                                <li class="list-footer list-footer--item">item</li>
                                <li class="list-footer list-footer--item">item</li>
                        ...
                        <div class="col-md-3 wrapper-footer"></div>
                    </div>
                </div>
            </footer>
        </div>
